...
require 'chatrix/bot/plugins/karma'
require 'chatrix/bot/plugins/url_info'
require 'chatrix/bot/plugins/you_tube'
require 'chatrix/bot/plugins/markov'
require 'chatrix/bot/plugins/movie'
require 'chatrix/bot/plugins/lastfm'
